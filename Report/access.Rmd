...
[GitHub WA Fatal Encounters With Police (WA-FEWP) repository](https://github.com/nextstepswa/WA-FEWP).
...
* *If you have a question* about the methodology, or the data, or the topic in general, please start a thread on the [repository discussions page](https://github.com/nextstepswa/WA-FEWP/discussions/1) (note: you'll need a GitHub account -- they're free, just follow the instructions at the link).
