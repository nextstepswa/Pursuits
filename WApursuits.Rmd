...
* Note that the value of the Pre vs. Post comparison will change as time moves on.   As the time since reform increases there may be new pursuit fatalities added to the post-reform period, and/or old pursuit fatalities added to the post-reform period since the lookback window will extend farther into the past.
